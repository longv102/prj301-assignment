 ...
 */
@WebServlet(name = "ShoppingSearchAllController", urlPatterns = {"/ShoppingSearchAllController"})
public class ShoppingSearchAllController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at ShoppingSearchAllController: " + e.toString());
        } finally {
